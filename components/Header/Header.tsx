...
//         </ul>
//       </div>
//       {/* Add justify-end to the flex container */}
//       <ul className="flex items-center justify-end w-full md:w-1/3 md:ml-auto mt-4 md:mt-0 space-x-6">
...
const Header = () => {
  return (
    <header className="py-10 px-4 container max-w-screen-xl mx-auto flex flex-wrap md:flex-nowrap items-center">
      ...
      {/* Add flex-grow to push navigation to the extreme right */}
